        ...
        if (prod_name.equals("")){
            ...
            StringRequest request = new StringRequest(Request.Method.POST, RequestURL.prod_insert,
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("prod_img", imageStr);
                    params.put("active", active);
                    params.put("crea_name", LOGGED_USER);
                    params.put("crea_date", DateAndTime.getDeviceDate());
                    params.put("crea_time", DateAndTime.getDeviceTime());
                    return params;
                }
            };
        ...
        if (prod_name.equals("")){
            ...
            StringRequest request = new StringRequest(Request.Method.POST, RequestURL.prod_update,
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("prod_spec", prod_spec);
                    params.put("prod_desc", prod_desc);
                    params.put("prod_img",  imageStr[0]);
                    params.put("active", active);
                    params.put("modi_user", LOGGED_USER);
                    params.put("modi_date", DateAndTime.getDeviceDate());
                    params.put("modi_time", DateAndTime.getDeviceTime());
                    return params;
                }
            };
