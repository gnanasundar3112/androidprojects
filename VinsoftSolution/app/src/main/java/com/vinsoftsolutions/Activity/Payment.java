...
import com.vinsoftsolutions.Database.PaymentDatabase;
...
public class Payment extends AppCompatActivity {
    ...
    private RecyclerView.LayoutManager PAYMENT_MANAGER;
    private Handler handler = new Handler();
    int dateIsClick = 0;
    private PaymentDatabase paymentDatabase = new PaymentDatabase(Payment.this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PAYMENT_RECYCLERVIEW = findViewById(R.id.payment_recycler);

        APPBAR_TITLE.setText(getApplicationContext().getString(R.string.payment));
        BACK_PRESS.setOnClickListener(view -> Payment.super.onBackPressed());

        PAYMENT_MANAGER = new GridLayoutManager(Payment.this,1);
        PAYMENT_RECYCLERVIEW.setLayoutManager(PAYMENT_MANAGER);
        ...
        FROM_DATE.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(Payment.this, from_date, CALENDAR.get(Calendar.YEAR),
        ...
        PROCESS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (from_date.equals("")){
                    Toast.makeText(Payment.this, "Please Select From Date", Toast.LENGTH_SHORT).show();
                }else if (to_date.equals("")){
                    Toast.makeText(Payment.this, "Please Select To Date", Toast.LENGTH_SHORT).show();
                }else {
                    CustomAlertDialog alertDialog = new CustomAlertDialog(Payment.this);
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            paymentDatabase.fetch(PAYMENT_RECYCLERVIEW,from_date,to_date,TOTAL);
                        }
                    }, 3000);
                }
            }
