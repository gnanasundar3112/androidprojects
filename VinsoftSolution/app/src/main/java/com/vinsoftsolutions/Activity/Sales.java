...
import com.vinsoftsolutions.Database.SalesDatabase;
...
public class Sales extends AppCompatActivity {
    ...
    private RecyclerView.LayoutManager SALES_MANAGER;
    private Handler handler = new Handler();
    int dateIsClick = 0;
    private SalesDatabase salesDatabase = new SalesDatabase(Sales.this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SALES_RECYCLERVIEW = findViewById(R.id.sales_recycler);

        APPBAR_TITLE.setText(getApplicationContext().getString(R.string.sales));
        BACK_PRESS.setOnClickListener(view -> Sales.super.onBackPressed());

        SALES_MANAGER = new GridLayoutManager(Sales.this,1);
        SALES_RECYCLERVIEW.setLayoutManager(SALES_MANAGER);
        ...
        FROM_DATE.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(Sales.this, from_date, CALENDAR.get(Calendar.YEAR),
        ...
        PROCESS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (from_date.equals("")){
                    Toast.makeText(Sales.this, "Please Select From Date", Toast.LENGTH_SHORT).show();
                }else if (to_date.equals("")){
                    Toast.makeText(Sales.this, "Please Select To Date", Toast.LENGTH_SHORT).show();
                }else {
                    CustomAlertDialog alertDialog = new CustomAlertDialog(Sales.this);
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            salesDatabase.fetch(SALES_RECYCLERVIEW,from_date,to_date,TOTAL);
                        }
                    }, 3000);
                }
            }
