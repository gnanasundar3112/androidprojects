...
import com.vinsoftsolutions.Database.PurchaseDatabase;
...
public class Purchase extends AppCompatActivity {
    ...
    private RecyclerView.LayoutManager PURCHASE_MANAGER;
    private Handler handler = new Handler();
    int dateIsClick = 0;
    private PurchaseDatabase purchaseDatabase = new PurchaseDatabase(Purchase.this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PURCHASE_RECYCLERVIEW = findViewById(R.id.purchase_recycler);

        APPBAR_TITLE.setText(getApplicationContext().getString(R.string.purchase));
        BACK_PRESS.setOnClickListener(view -> Purchase.super.onBackPressed());

        PURCHASE_MANAGER = new GridLayoutManager(Purchase.this,1);
        PURCHASE_RECYCLERVIEW.setLayoutManager(PURCHASE_MANAGER);
        ...
        FROM_DATE.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(Purchase.this, from_date, CALENDAR.get(Calendar.YEAR),
        ...
        PROCESS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (from_date.equals("")){
                    Toast.makeText(Purchase.this, "Please Select From Date", Toast.LENGTH_SHORT).show();
                }else if (to_date.equals("")){
                    Toast.makeText(Purchase.this, "Please Select To Date", Toast.LENGTH_SHORT).show();
                }else {
                    CustomAlertDialog alertDialog = new CustomAlertDialog(Purchase.this);
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            purchaseDatabase.fetch(PURCHASE_RECYCLERVIEW,from_date,to_date,TOTAL);
                        }
                    }, 3000);
                }
            }
