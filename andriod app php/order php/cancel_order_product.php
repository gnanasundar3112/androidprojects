...
$stmt = $con->prepare("SELECT a.order_no,a.order_date,a.prod_id,b.prod_name as prod_name,b.tamil_name as tamil_name,
        b.image as image,a.size_id,c.size_name as size_name,a.rate,a.qty,a.amount,a.status,a.modi_date FROM 
        salescancel as a left join`productmaster` as b on(a.prod_id=b.prod_id) left join `sizemaster` as c on
